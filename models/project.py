...
class RealEstateProject(models.Model):
    ...
    def _compute_apartment_count(self):
        for project in self:
            # Count all apartments linked to buildings in this project
            ...
            # Log for debugging
            _logger.info("Project %s: apartment_count=%s, product_count=%s",
                        project.name, direct_count, product_count)

            # Use the direct count
            project.apartment_count = direct_count
    ...
    def _compute_sold_available_apartment_count(self):
        for project in self:
            ...
            # Count available apartments for this project
            ...
            # Log for debugging
            _logger.info("Project %s: sold_count=%s, available_count=%s, reserved_count=%s",
